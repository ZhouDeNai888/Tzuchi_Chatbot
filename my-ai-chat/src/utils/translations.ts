...
export function getTranslation(language: "en" | "zh-TW", path: string): string {
  ...
  console.warn(
    `Translation is not a string for key: ${path} in language: ${language}`
  );
  return path;
}
...
export const translations = {
  en: {
    ...
    knowledgeDetail: {
      ...
      processing: {
        ...
        background:
          "Processing continued while you were away ({count} items still processing)",
      },
      creating: {
    ...
    agent: {
      ...
      form: {
        ...
        agentKeyHelp:
          "Used for API access. Will be auto-generated if left blank.",
        model: "Model",
        ...
        systemPromptPlaceholder:
          "Enter the system prompt that defines your agent's behavior...",
        fallbackMessage: "Fallback Message",
        fallbackMessagePlaceholder:
          "Message to display when no relevant information is found",
        fallbackMessageHelp:
          "This message will be shown when the system cannot find an answer in the knowledge base.",
    ...
    share: {
      ...
      description:
        "Manage the agents you have shared with external websites and users.",
      ...
      share: "Share",
      confirmRevoke:
        "Are you sure you want to revoke access for this shared agent?",
    ...
    preview: {
      ...
      previewDescription:
        "The chat widget should appear in the bottom-right corner of this page. Try sending a message to test it.",
      theme: "Theme",
      apiKey: "API Key",
    ...
    model_setting: {
      ...
      platformInfo: {
        ollama: {
          title: "Ollama Platform",
          description:
            "Ollama is a local AI platform that allows you to run large language models on your own hardware.",
          linkText:
            "Visit Ollama website for setup instructions and model downloads.",
        },
        gpt: {
          title: "OpenAI GPT Platform",
          description:
            "OpenAI GPT models provide state-of-the-art natural language processing capabilities.",
          linkText:
            "Visit OpenAI documentation for model details and API usage.",
        },
      },
    },
    profile: {
  ...
  "zh-TW": {
    ...
    agent: {
      ...
      shareSuccess: "助理分享成功",
      shareWarning:
        "請保護好此 API 金鑰。擁有此金鑰的任何人都可以使用您的助理。",
      apiKey: "API 金鑰",
      embedCode: "嵌入代碼",
      copyEmbed: "複製嵌入代碼",
      qrCode: "QR 碼",
    ...
    preview: {
      ...
      previewSection: "預覽",
      previewDescription:
        "聊天小工具應該會出現在頁面的右下角。嘗試發送一條訊息來測試它。",
      theme: "主題",
      apiKey: "API 金鑰",
    ...
    model_setting: {
      ...
      platformInfo: {
        ollama: {
          title: "Ollama 平台",
          description:
            "Ollama 是一個本地 AI 平台，允許您在自己的硬體上運行大型語言模型。",
          linkText: "訪問 Ollama 網站獲取設置說明和模型下載。",
        },
        gpt: {
          title: "OpenAI GPT 平台",
          description: "OpenAI GPT 模型提供最先進的自然語言處理能力。",
          linkText: "訪問 OpenAI 文檔獲取模型詳情和 API 使用說明。",
        },
      },
    },
    profile: {
