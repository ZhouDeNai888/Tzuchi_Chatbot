...
const ConfirmDeleteModal: React.FC<ConfirmDeleteModalProps> = ({
    ...
    const defaultTitle = agentT.confirmDeleteTitle || 'Confirm Delete';
    const defaultMessage = agentT.confirmDeleteMessage || 'Are you sure you want to delete this item? This action cannot be undone.';
    const defaultConfirmText = agentT.confirm || 'Delete';
