...
import { shareAgent, SharedAgentData, getSharedAgentByApiKey } from '@/utils/apiService';
...
const ShareAgentModal: React.FC<ShareAgentModalProps> = ({
    ...
    const agentT: AgentTranslations = {
        ...
        shareAgent: translationsObj.shareAgent as string || defaultAgentTranslations.shareAgent,
        shareSuccess: translationsObj.shareSuccess as string || defaultAgentTranslations.shareSuccess,
        shareWarning: translationsObj.shareWarning as string || defaultAgentTranslations.shareWarning,
        apiKey: translationsObj.apiKey as string || defaultAgentTranslations.apiKey,
        embedCode: translationsObj.embedCode as string || defaultAgentTranslations.embedCode,
        copyEmbed: translationsObj.copyEmbed as string || defaultAgentTranslations.copyEmbed,
        qrCode: translationsObj.qrCode as string || defaultAgentTranslations.qrCode,
        previewEmbed: translationsObj.previewEmbed as string || defaultAgentTranslations.previewEmbed,
        shareButton: translationsObj.shareButton as string || defaultAgentTranslations.shareButton,
        shareAnother: translationsObj.shareAnother as string || defaultAgentTranslations.shareAnother,

        // Safely handle nested objects by creating fresh objects
        form: {
            shareName: (translationsObj.form as any)?.shareName || defaultAgentTranslations.form.shareName,
            shareDescription: (translationsObj.form as any)?.shareDescription || defaultAgentTranslations.form.shareDescription,
            allowedOrigins: (translationsObj.form as any)?.allowedOrigins || defaultAgentTranslations.form.allowedOrigins,
            allowedOriginsHint: (translationsObj.form as any)?.allowedOriginsHint || defaultAgentTranslations.form.allowedOriginsHint,
            usageLimit: (translationsObj.form as any)?.usageLimit || defaultAgentTranslations.form.usageLimit,
            unlimited: (translationsObj.form as any)?.unlimited || defaultAgentTranslations.form.unlimited,
            expiryDays: (translationsObj.form as any)?.expiryDays || defaultAgentTranslations.form.expiryDays,
            neverExpires: (translationsObj.form as any)?.neverExpires || defaultAgentTranslations.form.neverExpires,
            // Ensure theme is always present
            theme: (translationsObj.form as any)?.theme || defaultAgentTranslations.form.theme
        },

        themeOptions: {
            light: (translationsObj.themeOptions as any)?.light || defaultAgentTranslations.themeOptions.light,
            dark: (translationsObj.themeOptions as any)?.dark || defaultAgentTranslations.themeOptions.dark
        }
    };
